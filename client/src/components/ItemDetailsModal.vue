...
const fetchReviews = async () => {
  ...
  try {
    const response = await axios.get(`http://localhost:3000/api/items/${props.item.id}/reviews`);
...
const submitReview = async () => {
  ...
  try {
    const response = await axios.post(`http://localhost:3000/api/items/${props.item.id}/reviews`, newReview.value, {
